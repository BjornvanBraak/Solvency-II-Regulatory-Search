...
class Embedding_Model(Enum):
    ...
    QWEN_3_EMBEDDING_SOLVENCY_II_V2 = {"display_name": "Qwen3-Embedding-8B-v2", "data-ingestion-pipeline": "v3", "model": "Qwen/Qwen3-Embedding-8B", "api_key": os.environ["DEEPINFRA_API_KEY"], "collection_name": "QWEN_SOLVENCY_II_V2", "persist_directory": SOLVENCY_II_REGULATION_SEARCH_PERSIST_DIRECTORY}
