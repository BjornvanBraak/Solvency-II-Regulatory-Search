...
class Embedding_Model(Enum):
    ...
    AZURE_TEXT_EMBEDDING_3_LARGE_SOLVENCY_V2 = {"display_name": "openai-text-embedding-3-large-v2", "data-ingestion-pipeline": "v2", "model":"text-embedding-3-large", "api_endpoint": os.environ["AZURE_OPENAI_ENDPOINT"], "api_version": os.environ["AZURE_TEXT_EMBEDDING_LARGE_VERSION"], "api_key": os.environ["AZURE_OPENAI_API_KEY"], "collection_name": "OPENAI_SOLVENCY_II_V2", "persist_directory": SOLVENCY_II_REGULATION_SEARCH_PERSIST_DIRECTORY}
    QWEN_3_EMBEDDING_SOLVENCY_II_V2 = {"display_name": "Qwen3-Embedding-8B-v2", "data-ingestion-pipeline": "v2", "model": "Qwen/Qwen3-Embedding-8B", "api_key": os.environ["DEEPINFRA_API_KEY"], "collection_name": "QWEN_SOLVENCY_II_V2", "persist_directory": SOLVENCY_II_REGULATION_SEARCH_PERSIST_DIRECTORY}
