...
![A concise summary of the logo for the European Insurance and Occupational Pensions Authority (EIOPA). The logo features a blue, translucent, rounded diamond shape with a circle of twelve yellow stars inside, representing the European Union. Below the graphic is the stylized lowercase acronym "eiopa" and the full name of the organization.

eiopa
EUROPEAN INSURANCE
AND OCCUPATIONAL PENSIONS AUTHORITY](#)

![A blue banner with the title "Guidelines on the use of internal models" in bold black text.
Guidelines on the use of internal models](#)

![A light blue banner with the title "Guidelines on the use of internal models" in bold black font.
Guidelines on the use of internal models](#)
...
4 [https://eiopa.europa.eu/Pages/Supervision/Insurance/draft-implementing-technical-standards-on-the-](https://eiopa.europa.eu/Pages/Supervision/Insurance/draft-implementing-technical-standards-on-the-%20%20supervisory-approval-processes-for-solvency-ii.aspx)
[supervisory-approval-processes-for-solvency-ii.aspx](https://eiopa.europa.eu/Pages/Supervision/Insurance/draft-implementing-technical-standards-on-the-%20%20supervisory-approval-processes-for-solvency-ii.aspx)
...
- _Internal model(s) for a group (or for groups)”_ should be understood as
...
- The concept of “ _richness of the probability distribution forecast_ ” is
...
- The “ _reference risk measure_ ” should be understood as the Value-at-Risk

of the basic own funds subject to a confidence level of 99.5% over a oneyear period as set out in Article 101(3) of Solvency II.


“

- _Analytical closed formulae_ ” should be understood as direct mathematical
...
- _t=0_ ” should be understood as the date of which the Solvency Capital
...
- _t=1_ ” should be understood as one year after the date of which the
...
design of the internal model is aligned with their business and their riskmanagement system, including the production of outputs, at group level and at
...
to make transparent both the assumptions and the process and decisionmaking criteria used for the selection of the assumptions and disregarding other
...
underlying variable at _t_ =0;


b) it understands the difference between the basic own funds and the

underlying variable in any situation up to and including _t_ =1, especially
...
effects on the balance sheet for solvency purposes between _t_ =0 and _t_ =1.
