...
![A concise summary of the logo for EIOPA, the European Insurance and Occupational Pensions Authority. The logo is blue and features a stylized diamond shape containing a circle of twelve stars, representing the European Union. Below the graphic is the acronym "eiopa" in a stylized font, with the full name of the authority written underneath.
...
![A light blue banner with the title "Guidelines on look-through approach" in bold black text.
...
undertakings should assume that all assets for which the actual single name
exposure is not identified belong to the same single name exposure.
...
repayment is contingent on the non-occurrence of a given catastrophe event,
...
Commission Delegated Regulation 2015/35, their treatment in the standard
formula should not result in a capital relief in respect of the catastrophe
...
for risk-mitigation techniques set out in Articles 208 to 215 of Commission
Delegated Regulation 2015/35, they should calculate the capital charge in
respect of mortality and spread risk as set out in paragraphs 1.24 to 1.28.
