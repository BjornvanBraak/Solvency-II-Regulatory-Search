...
![A title slide with bold, black text on a light blue background. The text reads 'Guidelines on own risk and solvency'.

Guidelines on own risk and solvency](#)

![A presentation slide with the title "Guidelines on own risk and solvency assessment" in bold black text on a light blue background.

Guidelines on own risk and solvency
assessment](#)


![This is a minimalist image featuring the word 'assessment' in a bold, black, lowercase sans-serif font. The text has a subtle drop shadow and is centered on a solid, light blue background.
