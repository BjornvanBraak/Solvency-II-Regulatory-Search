...
![A title slide with bold black text on a light blue background. The title reads "Guidelines on health catastrophe risk sub-module".

Guidelines on health catastrophe risk
sub-module](#)


![A concise summary of the word "sub-module" in bold, black, sans-serif font with a slight drop shadow, set against a solid light blue background.
