...
![This is a title slide with the text "Guidelines on undertaking-specific parameters" in bold, black font on a light blue background.

Guidelines on undertaking-specific
parameters](#)


![This is a simple image showing the word "parameters" in black, lowercase, sans-serif font with a slight drop shadow, set against a solid light blue background.
