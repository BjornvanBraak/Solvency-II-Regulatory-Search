...
![The logo of EIOPA, the European Insurance and Occupational Pensions Authority. The logo features a blue geometric shape enclosing a circle of European Union stars above the stylized text 'eiopa' and the full name of the authority on a white background.

eiopa
EUROPEAN INSURANCE
AND OCCUPATIONAL PENSIONS AUTHORITY](#)

![A presentation slide header showing the title "Guidelines on the use of internal models" in a bold, black sans-serif font on a light blue background.

Guidelines on the use of internal models](#)

![A presentation slide with a light blue background features the title "Guidelines on the use of internal models" in bold, black sans-serif font.
