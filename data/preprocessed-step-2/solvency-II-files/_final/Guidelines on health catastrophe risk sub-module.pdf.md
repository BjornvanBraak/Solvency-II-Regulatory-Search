...
![A close-up of the logo for the European Insurance and Occupational Pensions Authority (EIOPA). The logo features a blue, translucent, rounded diamond shape containing a circle of twelve yellow stars, similar to the European Union flag. Below the emblem is the acronym "eiopa" in a stylized lowercase font, followed by the full name of the organization in all caps. The background is white.
...
1.3. These Guidelines aim at facilitating convergent practices across Member States
...
1.4. The calculations for the determination of the capital requirement for the health
catastrophe risk sub-module should be consistent with the design and
calibration of the underlying scenarios.


1.5. Insurance and reinsurance undertakings may face different situations
depending on the characteristics of their products and the national legislations.


1.6. For the purpose of these Guidelines the following definition has been developed:


      ‘Single claim’ means a claim following the occurrence of one particular

event to one identified insured person.
...
the calculations of the capital requirements for the health catastrophe risk submodule and the effects described in the scenarios can have different causes,
undertakings should use in the calculation the cause resulting in the highest
loss in basic own funds. In particular, undertakings should not exclude the
scenario where some potential causes of the catastrophe scenario are excluded
by policy terms and conditions (e.g. terrorism).
...
of the cause, and for additional benefits in case of death caused by an accident,
undertakings should take only the additional benefits into account when
calculating the value of the benefits referred to in Article 161 (3)(b) and Article
162 (4) (c) of Commission Delegated Regulation 2015/35, provided the
...
1.11. Where additional recurring benefit payments are provided for in case of death
...
rate curve) taking into account relevant demographic characteristics.
Undertakings should also reflect in the calculation the contractual duration of
the recurring benefit payments.


1.12. Where no or insufficient demographic data is available undertakings should use
...
1.13. In the calculation of the value of the benefits, undertakings should account for
...
determine the value of the benefits referred to in Article 161 (3) (b) and Article
162 (4) (c) of Commission Delegated Regulation 2015/35:
...
(c) Step 3: calculation of the average between the two values determined
in step 2 weighted by the proportion calculated in step 1.


1.15. Notwithstanding paragraph 1 of this Guideline, when the choice between a
...
1.17. Where the amount of the disability benefit payments depends on the degree of
...
1.18. Undertakings should justify the assumptions underlying the calculation of the
...
1.19. In the calculation of the best estimate of the recurring benefit payments for the
...
1.20. For the calculation undertakings should make realistic assumptions on the
...
1.21. In the calculation of the value of benefits, undertakings should account for
...
1.23. Where the amount of the disability benefit payments depends on the degree of
...
1.25. In the calculation undertakings should account for expected increases in the
...
1.26. Undertakings should calculate the average amounts in the case of the event

type “Medical treatment caused by an accident” as the benefits for medical
treatment caused by an accident observed during prior years, including related
expenses, divided by the number of single claims corresponding to these

benefits.


1.27. Undertakings should ensure that the observation period is long enough to


minimise statistical errors.


1.28. For the calculation of the average amounts, undertakings should adjust past

data for the inflation rate of medical payments.


1.29. Where a medical treatment is expected to last more than one year,
...
1.30. Undertakings should appropriately discriminate between benefits paid for
...
1.31. For the calculation of the value of the benefits referred to in Article 162 (4) (c)

of Commission Delegated Regulation 2015/35, undertakings should apply the
same principles as set out in Guidelines 2 to 4.


1.32. Where an insured person is covered by two or more contracts with benefit

payments in the case of the event type _e_ and which are not mutually exclusive,
undertakings should add up the benefit payments for the different contracts to
determine SI( _e,i_ ) as referred to in Article 162 (4) (c) of Commission Delegated
Regulation 2015/35.
--- Page 6 ---
...
Article 163 (2) (b) of Commission Delegated Regulation 2015/35, in the same
...
healthcare utilisation _h_ as referred to in Article 163 of Commission Delegated
Regulation 2015/35 as the product of:


(a) the expected number of healthcare treatments _h_ for an insured person;


(b) the expected average claim cost for a single healthcare treatment _h_
...
1.35. Undertakings should make an accurate estimation, based on their own

experience, of:


(a) the expected number of uses of each healthcare treatment _h_ ;


(b) the average claim cost for a single use of each healthcare treatment _h_ .


1.36. When undertakings can justify that past experience does not allow for an

accurate estimation, they should use as the expected number of healthcare
treatments for the healthcare utilisation type “Hospitalisation” and “No formal
...
1.37. Undertakings should adjust the estimation of the average claim cost for the
