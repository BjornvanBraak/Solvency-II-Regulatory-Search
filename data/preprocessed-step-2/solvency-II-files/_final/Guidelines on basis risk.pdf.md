...
![A logo for the European Insurance and Occupational Pensions Authority (EIOPA). The logo features a blue, translucent, rounded diamond shape containing a circle of twelve yellow stars, similar to the European Union flag. Below the graphic is the stylized lowercase text "eiopa" and the full name of the authority in uppercase. The background is white.
...
![A light blue banner with the title "Guidelines on basis risk" in bold black text.
Guidelines on basis risk](#)
