...
![The logo of EIOPA, the European Insurance and Occupational Pensions Authority. The logo features a blue rhombus containing the European Union's circle of twelve stars above the organization's name.

eiopa
EUROPEAN INSURANCE
AND OCCUPATIONAL PENSIONS AUTHORITY](#)

![A presentation slide with the title "Guidelines on own risk and solvency" in bold black text on a light blue background. This likely pertains to financial regulation, risk management, or insurance frameworks.

Guidelines on own risk and solvency](#)

![A concise summary of a title slide with the text "Guidelines on own risk and solvency assessment" in a bold, black sans-serif font on a light blue background.

Guidelines on own risk and solvency
assessment](#)


![A simple digital graphic with the word 'assessment' written in bold, black, lowercase letters with a subtle drop shadow on a solid light blue background.
assessment](#)
...
insurance and reinsurance (hereinafter “Solvency II”) [2] .
...
“Commission Delegated Regulation 2015/35”) [3] .
