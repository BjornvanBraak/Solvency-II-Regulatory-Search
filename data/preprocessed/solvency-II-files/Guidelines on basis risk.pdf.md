...
The logo of the European Insurance and Occupational Pensions Authority (EIOPA) on a white background. The logo consists of a blue, translucent rhombus shape containing a circle of twelve yellow stars, symbolizing the European Union. Below the graphic is the stylized lowercase acronym "eiopa" and the full name of the authority in black uppercase letters.
...
![A simple image showing the text "Guidelines on basis risk" in a bold, black, sans-serif font, centered on a plain light blue background. This could be a title slide for a presentation or a header for a document.

Guidelines on basis risk](#)

![A presentation slide header with the title "Guidelines on basis risk" in a bold, black font on a light blue background.
Guidelines on basis risk](#)
...
undertaking under a comprehensive set of risk scenarios, including

scenarios that are consistent with the confidence level set out in Article
...
1.12. Where the terms and conditions of a risk-mitigation technique specify a cap on

the maximum loss protection as a proportion of the initial exposure,
undertakings should apply the assessment only to the proportion covered by
the risk-mitigation technique when determining whether the basis risk is
