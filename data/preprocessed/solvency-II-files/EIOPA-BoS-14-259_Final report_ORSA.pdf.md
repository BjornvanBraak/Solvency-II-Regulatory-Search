...
![This is the logo for EIOPA, the European Insurance and Occupational Pensions Authority. The logo features the acronym "eiopa" in a stylized black font below a blue, transparent, rhombus-like shape containing the European Union's circle of yellow stars on a white background.

eiopa
EUROPEAN INSURANCE
AND OCCUPATIONAL PENSIONS AUTHORITY](#)

![This is the title slide for the "Final Report on Public Consultation No. 14/017 on Guidelines on own risk and solvency assessment". The slide features bold, black text on a light blue background.
...
A slide titled "Guideline 1 - General approach" outlining the requirements for an undertaking's Own Risk and Solvency Assessment (ORSA). The text specifies that the undertaking must develop its own processes and techniques, tailored to its organizational structure, risk-management system, and the specific nature, scale, and complexity of its business risks.
...
![This is a presentation slide for Guideline 2, which outlines the top-down approach for the AMSB's role in the ORSA. The guideline states that the AMSB should actively participate by steering the assessment and challenging its results.
...
![An image slide presenting "Guideline 3 - Documentation" which lists the minimum required documentation for an ORSA (Own Risk and Solvency Assessment). The required documents include the policy for the ORSA, a record of each ORSA, an internal report on each ORSA, and a supervisory report of the ORSA.
...
![**Summary:**
A presentation slide detailing "Guideline 4 - Policy for the ORSA" (Own Risk and Solvency Assessment). The slide outlines the required components of an ORSA policy, which must be approved by the AMSB. Key requirements include descriptions of processes, the link between risk profile and solvency needs, and methodologies for stress tests, data quality standards, assessment frequency, and timing.
...
![A slide presenting Guideline 5, which mandates that a record be kept for each ORSA (Own Risk and Solvency Assessment). The guideline specifies that undertakings must evidence and document each ORSA and its outcome.
...
![A slide for Guideline 6 regarding internal reporting on the ORSA (Own Risk and Solvency Assessment). It states that an undertaking must communicate the results and conclusions of the ORSA to relevant staff after approval by the AMSB.
...
![A presentation slide for Guideline 7, titled "Assessment of the overall solvency needs". It outlines that an undertaking must quantify its capital needs, describe measures for addressing all material risks (both quantifiable and non-quantifiable), and use stress tests or scenario analyses to provide an adequate basis for the solvency assessment.
...
![This is a slide presenting Guideline 8, which outlines the need for a forward-looking perspective in the overall solvency needs assessment for an undertaking, incorporating medium or long-term views.
...
![A slide presenting Guideline 9 concerning the valuation and recognition bases for assessing overall solvency needs. It instructs undertakings that use methods different from the Solvency II bases to explain how their chosen methods better reflect their specific risk profile, risk tolerance, and business strategy. They must also quantitatively estimate the impact of these different bases on their solvency assessment.
...
![A slide outlining Guideline 10 on continuous compliance with Solvency II regulatory capital requirements. It details the necessary assessments, including analyzing changes in risk profile, the quantity and quality of own funds, and the composition of own funds over the business planning period.
...
![A presentation slide for "Guideline 11 – Continuous compliance with technical provisions". It outlines the responsibilities of an undertaking's actuarial function, which include providing input on compliance with calculation requirements and identifying potential risks from uncertainties in these calculations.
...
![This is a slide presenting Guideline 12, which details the process for handling deviations from the assumptions used in the Solvency Capital Requirement (SCR) calculation. It advises that undertakings should first perform a qualitative analysis to assess if their risk profile's deviation is significant, which determines if a quantitative assessment is necessary.
...
available to undertakings on EIOPA’s website [8] .
...
![A slide showing Guideline 13, which links the ORSA (Own Risk and Solvency Assessment) to the strategic management process and decision-making framework. The guideline specifies that ORSA insights must be considered in capital management, business planning, and product development and design.
...
![A concise summary of Guideline 14, which specifies the frequency for performing an ORSA (Own Risk and Solvency Assessment). The guideline states that an undertaking should conduct the ORSA at least annually.
...
![A slide outlining Guideline 15 regarding the scope of a group's Own Risk and Solvency Assessment (ORSA). The guideline specifies that insurance/reinsurance undertakings and holding companies must design the group ORSA to reflect the group's structure, risk profile, and cover all material risks from all entities within the group.
...
![A concise summary of Guideline 16 regarding reporting to supervisory authorities. The guideline specifies that insurance, reinsurance, and holding companies must submit a group supervisory ORSA report to the group supervisor. The report must be in the same language as the group Regular Supervisory Reporting. It also outlines the requirement to provide a timely translation of relevant ORSA information if requested by a member of the college.
...
![This is a slide detailing "Guideline 17 - Group specificities on overall solvency needs". It outlines the requirements for insurance and financial groups to assess group-specific risks and their impact on overall solvency needs as part of their ORSA (Own Risk and Solvency Assessment). The guideline lists five key factors to consider: sources and needs for capital, capital availability and transferability, impact of capital transfers, alignment of strategies, and specific group risks.
...
![A concise summary of Guideline 18, detailing the group-specific factors for continuous compliance with regulatory capital requirements. The guideline specifies that an insurance or holding company's group ORSA record must describe the assessment of its own funds (sources, availability, transfers), the alignment of individual and group strategies, and the specific risks the group faces.
...
![**1. Summary**
A slide presenting Guideline 19 from the Solvency II framework, which outlines the specific requirements for submitting a single ORSA (Own Risk and Solvency Assessment) document. The guideline lists four key provisions for an insurance or reinsurance undertaking to provide to the group supervisor, covering the scope of undertakings, governance processes, document organization for supervisory colleges, and translation needs.
