...
![This is the logo for EIOPA, the European Insurance and Occupational Pensions Authority. The logo features a blue, transparent, rhombus-like shape containing a circle of twelve white stars, reminiscent of the European Union flag. Below this symbol is the stylized lowercase acronym "eiopa" in black, followed by the full name of the authority in uppercase black text. The background is white.

eiopa
EUROPEAN INSURANCE
AND OCCUPATIONAL PENSIONS AUTHORITY](#)

![A presentation slide with the title "Guidelines on the use of internal models" in bold black text on a light blue background.
Guidelines on the use of internal models](#)

![A presentation slide title or banner with the bold black text "Guidelines on the use of internal models" centered on a light blue background.
